...
namespace Megastonks.Migrations
{
    ...
    [Migration("20230323034700_MessageViewers")]
    partial class MessageViewers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Megastonks.Entities.Account", b =>
                {
                    ...
                    b.Property<int?>("MessageViewerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Megastonks.Entities.MessageViewer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Megastonks.Entities.Account", b =>
                {
                    b.HasOne("Megastonks.Entities.MessageViewer", null)
                        .WithMany("Viewers")
                        .HasForeignKey("MessageViewerId");
            ...
            modelBuilder.Entity("Megastonks.Entities.MessageViewer", b =>
                {
                    b.HasOne("Megastonks.Entities.Message", "Message")
                        .WithMany()
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
